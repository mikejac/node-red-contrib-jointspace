...
module.exports = function(RED) {
    ...
    function jointSPACEGetNode(config) {
        ...
        this.api = this.clientConn.register(this, 'in');
        ...
        this.on('input', function (msg) {
            RED.log.debug("jointSPACEInNode(input)");

            let topicArr = msg.topic.split(node.topicDelim);
            let topic    = topicArr[topicArr.length - 1];   // get last part of topic

            RED.log.debug("jointSPACEInNode(input): topic = " + topic);
    ...
    function jointSPACESetNode(config) {
        ...
        this.api = this.clientConn.register(this, 'out');
         ...
         */
        this.on('input', function (msg) {
            RED.log.debug("jointSPACEOutNode(input)");

            let topicArr = msg.topic.split(node.topicDelim);
            let topic    = topicArr[topicArr.length - 1];   // get last part of topic

            RED.log.debug("jointSPACEOutNode(input): topic = " + topic);
